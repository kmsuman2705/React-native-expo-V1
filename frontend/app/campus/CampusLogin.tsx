...
import { login } from '../api/campusApi'; // Ensure this is properly implemented in the api.js file
...
const CampusLogin = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.token) {
        ...
        router.push('/campus/campus-dashboard');
      } else {
  ...
  const handleSignUp = () => {
    router.push('/campus/CampusSignup');
  };
