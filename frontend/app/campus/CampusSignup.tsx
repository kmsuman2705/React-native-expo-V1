...
import { register } from '../api/campusApi'; // Import the register function from api.js
const Campussignup = () => {
    ...
    if (!collegeName || !email || !contactNumber || !password || !confirmPassword) {
      ...
      try {
        ...
        if (response.success) {
          ...
          router.push('/campus/CampusLogin'); // Redirect to login page on success
        } else {
  ...
  const handleLogin = () => {
    router.push('/campus/CampusLogin'); // Redirect to login page
  };
